# Based on https://github.com/adafruit/Adafruit_Learning_System_Guides/blob/main/PyPortal_OpenWeather/code.py 
#
...
DATA_SOURCE = 
DATA_SOURCE += "&appid="+secrets['cm']
# cm is the coin metrics api key
DATA_LOCATION = []
